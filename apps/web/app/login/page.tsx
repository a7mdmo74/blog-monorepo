...
const BACKEND_URL = API_URL.replace("/graphql", "");
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8">
            <a
              ...
              className="flex w-full items-center justify-center gap-3 rounded-full border border-border bg-card px-6 py-3 text-sm font-semibold transition-colors hover:border-foreground hover:shadow-md"
            >
